...
Attributes:
    ...
    STRATAAI_ROOT (Path): Root path for StrataAI files.
...
from StrataAI.config2 import merge_dict
from StrataAI.configs.llm_config import LLMConfig
...
class ModelsConfig(YamlModel):
    ...
    Methods:
        ...
        from_home(cls, path): Loads configuration from ~/.StrataAI/config2.yaml.
    ...
    def from_home(cls, path):
        """
        Loads configuration from ~/.StrataAI/config2.yaml.
