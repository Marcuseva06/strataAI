...
from StrataAI.environment.base_env import ExtEnv, mark_as_writeable
from StrataAI.environment.base_env_space import BaseEnvAction, BaseEnvObsParams
from StrataAI.environment.minecraft.const import (
    MC_CKPT_DIR,
...
from StrataAI.environment.minecraft.process_monitor import SubprocessMonitor
    ...
    def _post_init_ext_env(self):
        if not self.mineflayer:
            self.mineflayer = SubprocessMonitor(
                commands=[
                    "node",
                    STRATAAI_ROOT.joinpath("StrataAI", "environment", "minecraft", "mineflayer", "index.js"),
