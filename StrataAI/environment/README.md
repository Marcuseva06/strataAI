Here is a environment description of StrataAI env for different situation.  
...
- Define `Environment`(Base Class) which is the env that StrataAI directly used. And it includes roles and so on.
...
```
from StrataAI .environment.api.env_api import EnvAPIAbstract
