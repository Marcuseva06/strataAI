...
from StrataAI.configs.browser_config import BrowserConfig
from StrataAI.configs.embedding_config import EmbeddingConfig
from StrataAI.configs.file_parser_config import OmniParseConfig
from StrataAI.configs.llm_config import LLMConfig, LLMType
from StrataAI.configs.mermaid_config import MermaidConfig
from StrataAI.configs.redis_config import RedisConfig
from StrataAI.configs.s3_config import S3Config
from StrataAI.configs.search_config import SearchConfig
from StrataAI.configs.workspace_config import WorkspaceConfig
from StrataAI.const import CONFIG_ROOT, STRATAAI_ROOT
...
class Config(CLIParams, YamlModel):
    ...
    def from_home(cls, path):
        """Load config from ~/.StrataAI/config2.yaml"""
    ...
    def default(cls):
        ...
        default_config_paths: List[Path] = [
            StrataAI_ROOT / "config/config2.yaml",
