...
Usage:
    python3 -m StrataAI.actions.write_docstring <filename> [--overwrite] [--style=<docstring_style>]
...
Example:
    python3 -m StrataAI.actions.write_docstring ./StrataAI/software_company.py --overwrite False --style=numpy
...
from StrataAI.utils.common import OutputParser, aread, awrite
from StrataAI.utils.pycst import merge_docstring
