...
from StrataAI.config2 import config
from StrataAI.const import (
    AGGREGATION,
    COMPOSITION,
...
from StrataAI.logs import logger
from StrataAI.repo_parser import DotClassInfo, RepoParser
from StrataAI.schema import UMLClassView
from StrataAI.utils.common import concat_namespace, split_namespace
from StrataAI.utils.di_graph_repository import DiGraphRepository
from StrataAI.utils.graph_repository import GraphKeyword, GraphRepository
...
class RebuildClassView(Action):
    ...
    def _diff_path(path_root: Path, package_root: Path) -> (str, str):
        ...
        Example:
            >>> _diff_path(path_root=Path("/Users/x/github/StrataAI"), package_root=Path("/Users/x/github/StrataAI/StrataAI"))
            "-", "StrataAI"

            >>> _diff_path(path_root=Path("/Users/x/github/StrataAI/StrataAI"), package_root=Path("/Users/x/github/StrataAI/StrataAI"))
            "=", "."
        """
    ...
    def _align_root(path: str, direction: str, diff_path: str) -> str:
        ...
        Example:
            >>> _align_root(path="StrataAI/software_company.py", direction="+", diff_path="StrataAI")
            "StrataAI/StrataAI/software_company.py"
