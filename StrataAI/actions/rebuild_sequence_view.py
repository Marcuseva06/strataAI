...
from StrataAI.const import GRAPH_REPO_FILE_REPO
from StrataAI.logs import logger
from StrataAI.repo_parser import CodeBlockInfo, DotClassInfo
from StrataAI.schema import UMLClassView
from StrataAI.utils.common import (
    add_affix,
    aread,
    auto_namespace,
    concat_namespace,
...
from StrataAI.utils.graph_repository import SPO, GraphKeyword, GraphRepository
...
class RebuildSequenceView(Action):
    ...
    def _get_full_filename(root: str | Path, pathname: str | Path) -> Path | None:
        ...
        Examples:
            If `root`(workdir) is "/User/xxx/github/StrataAI/StrataAI", and the `pathname` is
            "StrataAI/management/skill_manager.py", then the returned value will be
            "/User/xxx/github/StrataAI/StrataAI/management/skill_manager.py"
        """
