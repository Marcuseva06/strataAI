...
<p align="center">
<a href=""><img src="resources/StrataAI-new-log.png" alt="StrataAI logo: 使 GPT 以软件公司的形式工作，协作处理更复杂的任务" width="150px"></a>
</p>
...
1. StrataAI输入**一句话的老板需求**，输出**用户故事 / 竞品分析 / 需求 / 数据结构 / APIs / 文件等**
2. StrataAI内部包括**产品经理 / 架构师 / 项目经理 / 工程师**，它提供了一个**软件公司**的全过程与精心调配的SOP
...
> 您可以这样使用 conda：`conda create -n StrataAI python=3.9 && conda activate StrataAI`

```bash
pip install StrataAI
StrataAI --init-config  # 创建 ~/.StrataAI/config2.yaml，根据您的需求修改它
StrataAI "创建一个 2048 游戏"  # 这将在 ./workspace 创建一个仓库
```
...
### Docker安装
> 注意：在Windows中，你需要将 "/opt/StrataAI" 替换为Docker具有创建权限的目录，比如"D:\Users\x\StrataAI"
...
### 快速开始的演示视频
- 在 [StrataAI Huggingface Space](https://huggingface.co/spaces/deepwisdom/StrataAI-SoftwareCompany) 上进行体验
- [Matthew Berman: How To Install StrataAI - Build A Startup With One Prompt!!](https://youtu.be/uT75J_KG_aY)
- [官方演示视频](https://github.com/geekan/StrataAI/assets/2707039/5e8c1062-8c35-440f-bb20-2b0320f8d27d)
...
- 🔎 [StrataAI的能力及应用场景](https://docs.deepwisdom.ai/main/zh/guide/get_started/introduction.html)
- 🛠 如何构建你自己的智能体？
  - [StrataAI的使用和开发教程 | 智能体入门](https://docs.deepwisdom.ai/main/zh/guide/tutorials/agent_101.html)
  - [StrataAI的使用和开发教程 | 多智能体入门](https://docs.deepwisdom.ai/main/zh/guide/tutorials/multi_agent_101.html)
- 🧑‍💻 贡献
  - [开发路线图](ROADMAP.md)
- 🔖 示例
...
- **GitHub 问题：** 对于更技术性的问题，您也可以在我们的 [GitHub 仓库](https://github.com/geekan/StrataAI/issues) 中创建一个新的问题。

我们会在2-3个工作日内回复所有问题。

## 引用

如果您在研究论文中使用 StrataAI 或 Data Interpreter，请引用我们的工作：
