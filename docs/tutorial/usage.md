...
- Configure your `api_key` in any of `~/.StrataAI/config2.yaml / config/config2.yaml`
- Priority order: `~/.StrataAI/config2.yaml > config/config2.yaml`
...
```shell
StrataAI "Write a cli snake game based on pygame"
```

### Usage

```
 Usage: StrataAI [OPTIONS] [IDEA]                                                                                                                                                                                          
...
│ --init-config                --no-init-config             Initialize the configuration file for StrataAI. [default: no-init-config]                                                                                     │
