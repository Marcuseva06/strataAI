...
- 在 `~/.StrataAI/config2.yaml / config/config2.yaml` 中配置您的 `api_key`
- 优先级顺序：`~/.StrataAI/config2.yaml > config/config2.yaml`
...
StrataAI "写一个命令行贪吃蛇" --code_review
```
